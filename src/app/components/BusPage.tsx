      ...
      <div className="grid grid-cols-2 gap-2.5 flex-1 overflow-y-auto">
        {departures.map((bus, i) => (
          ...
          >
            ...
            {/* Minutes badge */}
            <div className={`absolute top-1.5 right-1.5 flex items-center gap-1 text-[9px] font-medium px-1.5 py-0.5 rounded-full ${
              bus.isSoon 
            ...
            <div className="relative flex items-center gap-2">
              <div className={`w-11 h-11 rounded-xl flex items-center justify-center text-lg font-semibold transition-transform duration-300 group-hover:scale-105 ${
                bus.isSoon 
              ...
              <div className="flex-1">
                <div className="text-[8px] uppercase tracking-wide text-stone-500 leading-none mb-0.5">
                  {bus.stop}
                </div>
